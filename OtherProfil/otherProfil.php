...
<head>
	<meta charset="utf-8">
	<link rel="stylesheet" type="text/css" href="otherProfil.css">
	...
	<div class='row'>
		<div class='col-5'>
			<div class="card" style="width: 18rem;">
		 		<div class="card-body">
		    		<?php
						include '../Accueil/onePageBack.php';
					?>
					<div class='infos'>
						<div class='infoTweet'>
							Tweets
							<?php
								include "../Accueil/Infos/tweets.php";
							?>
						</div>
						<div class='infoAbonnement'>
							...
							<?php
								include "../Accueil/Infos/Abonnements/abonnements.php";
							?>
						...
						<div class='infoAbo'>
							...
							<?php
								include "../Accueil/Infos/Abonnes/abonnees.php";
							?>
						</div>
					</div>
		  		</div>
			...
			<div class="card" style="width: 18rem;">
		 		<div class="card-body">
		   			<div class='edit'>
		   				<a href='#'><strong>Envoyer un message</strong></a>
		   			</div>
		  		</div>
			</div>
			...
			<div class="card" style="width: 18rem;">
		 		<div class="card-body">
		   			...
		   			<?php
		   				include '../Accueil/Suggestion/suggestion.php';
		   			?>
		  		</div>
			</div>		
			...
			<div class="card" style="width: 18rem;">
		 		<div class="card-body">
		   			...
		   			<?php
		   				include "../Accueil/Tendance/tendance.php";
		   			?>
		  		</div>
			</div>	
			...
			<div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
			  <div class="modal-dialog" role="document">
			    <div class="modal-content">
			      ...
			      <?php
			      	include '../Accueil/Infos/Abonnements/showNameAbonnement.php';
			      ?>
			      </div>
			...
			<div class="modal fade" id="exampleModalLongAbo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
			  <div class="modal-dialog" role="document">
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			      <?php
			       		include '../Accueil/Infos/Abonnes/showNameAbonnes.php';
			      ?>
			      </div>
			      <div class="modal-footer">
			        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
      ...
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
       	...
       	<form method="POST" action="../Accueil/WriteTweet/tweetText.php">
     		<div class="modal-body">
         		...
         		<script src="../Accueil/WriteTweet/maxLengthTweet.js"></script>
      		</div>
    		<div class="modal-footer">
...
<script src="AJAX/ajaxSameFollowAndCount.js"></script>
