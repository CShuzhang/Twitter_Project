...
class show{
	...
	public function abonnement(){
		$requete = "SELECT text, first_name, last_name, pseudo, tweets.id FROM follows LEFT JOIN tweets ON follows.id_following = tweets.id_poster LEFT JOIN users ON follows.id_following = users.id WHERE id_follower = '".$_SESSION['id']."' ORDER BY tweet_date DESC";
