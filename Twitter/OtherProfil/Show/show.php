...
class show{
	...
	public function abonnement(){
		$requete = "SELECT tweets.id as theId, text, first_name, last_name, pseudo, users.id FROM users LEFT JOIN tweets ON users.id = tweets.id_poster WHERE users.id =".$_GET['id']." ORDER BY tweets.id DESC";
